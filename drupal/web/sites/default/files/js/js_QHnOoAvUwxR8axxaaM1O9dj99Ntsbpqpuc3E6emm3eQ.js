...
/**
 * @file
 * CKEditor 'ckeditor_bootstrap_widgets' plugin admin behavior.
 */
...
(function ($, Drupal, drupalSettings) {
  ...
  /**
   * Provides the summary for the "ckeditor_bootstrap_widgets" plugin settings vertical tab.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *   Attaches summary behaviour to the "ckeditor_bootstrap_widgets" settings vertical tab.
   */

  Drupal.behaviors.ckeditor_bootstrap_widgetsSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="jsplusBootstrapWidgets"]').drupalSetSummary(function (context) {
        return 'JS+ Bootstrap Widgets configuration';
      });
      $('head').append('<style>' +
          ...
          '</style>')
      $('details[data-ckeditor-plugin-id=jsplusBootstrapWidgets] [data-url-help]').each(
          function() {
      ...
      $('details[data-ckeditor-plugin-id=jsplusBootstrapWidgets] [data-param-priority]').each(
          function() {
...
/**
 * @file
 * CKEditor 'ckeditor_bootstrap_table_tools' plugin admin behavior.
 */
...
(function ($, Drupal, drupalSettings) {
  ...
  /**
   * Provides the summary for the "ckeditor_bootstrap_table_tools" plugin settings vertical tab.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *   Attaches summary behaviour to the "ckeditor_bootstrap_table_tools" settings vertical tab.
   */

  Drupal.behaviors.ckeditor_bootstrap_table_toolsSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="jsplusBootstrapTableTools"]').drupalSetSummary(function (context) {
        return 'JS+ Bootstrap Table Tools add-ons configuration';
      });
      $('head').append('<style>' +
          '.jsplus_help_link { width: 15px;height: 15px;display: inline-block;border: 1px solid #7db8ff; border-radius: 8px; color: #0074ff; font-weight:bold; margin-left: 5px;text-align: center;font-size:13px }' +
          '.jsplus_help_link:hover, .jsplus_help_link:focus { background-color: #0074ff; border-color: #0074ff; color: white; text-decoration: none; }' +
          '</style>')
      $('details[data-ckeditor-plugin-id=jsplusBootstrapTableTools] [data-url-help]').each(
          function() {
              var url = this.getAttribute('data-url-help');
              var param = this.getAttribute('data-param-name');
              if (url == '')
      ...
      $('details[data-ckeditor-plugin-id=jsplusBootstrapTableTools] [data-param-priority]').each(
          function() {
            var priority = this.getAttribute('data-param-priority');
            if (priority.length == 0)
                return;
...
/**
 * @file
 * CKEditor 'ckeditor_bootstrap_editor' plugin admin behavior.
 */
...
(function ($, Drupal, drupalSettings) {
  ...
  /**
   * Provides the summary for the "ckeditor_bootstrap_editor" plugin settings vertical tab.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *   Attaches summary behaviour to the "ckeditor_bootstrap_editor" settings vertical tab.
   */

  Drupal.behaviors.ckeditor_bootstrap_editorSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="jsplusBootstrapEditor"]').drupalSetSummary(function (context) {
        return 'JS+ Bootstrap Editor configuration';
      });
      $('head').append('<style>' +
          '.jsplus_help_link { width: 15px;height: 15px;display: inline-block;border: 1px solid #7db8ff; border-radius: 8px; color: #0074ff; font-weight:bold; margin-left: 5px;text-align: center;font-size:13px }' +
          '.jsplus_help_link:hover, .jsplus_help_link:focus { background-color: #0074ff; border-color: #0074ff; color: white; text-decoration: none; }' +
          '</style>')
      $('details[data-ckeditor-plugin-id=jsplusBootstrapEditor] [data-url-help]').each(
          function() {
              var url = this.getAttribute('data-url-help');
              var param = this.getAttribute('data-param-name');
              if (url == '')
      ...
      $('details[data-ckeditor-plugin-id=jsplusBootstrapEditor] [data-param-priority]').each(
          function() {
            var priority = this.getAttribute('data-param-priority');
            if (priority.length == 0)
                return;
