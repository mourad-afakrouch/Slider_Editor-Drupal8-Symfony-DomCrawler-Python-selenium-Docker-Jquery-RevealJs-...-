CKEditor Bootstrap Table Tools module for easy creating and editing tables inside CKEditor in Drupal 8.
...
6. Go to node create/edit page, choose the text format with CKEditor Bootstrap Table Tools plugins.
