...
/**
 * @file
 * Contains \Drupal\ajax_search_block\Controller\APIController.
 */
...
class APIController extends ControllerBase {
  ...
  public function get_pages( Request $request ) {
  	...
  	if(count($params) > 0 && !empty($params['t'])){
  		$response['nodes'] = $this->_get_all_nodes_and_taxonomies($params['t']);
  	}
    $response['method'] = 'GET';
 ...
 * @return object.
 */
	function _get_all_nodes_and_taxonomies($text){
