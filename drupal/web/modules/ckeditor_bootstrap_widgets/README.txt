CKEditor Bootstrap Widgets module adds the feature to insert and edit Bootstrap widgets (components) in Drupal 8
...
6. Go to node create/edit page, choose the text format with CKEditor Bootstrap Widgets plugins.
